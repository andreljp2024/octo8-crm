...
import { Users, Search, Filter, Plus, Building2, UserCircle, Activity, ChevronRight, Mail, Phone } from 'lucide-react';
import { cn } from '@/lib/utils';

// Mock Data
const MOCK_CUSTOMERS = [
  { id: 'c-1', name: 'TechCorp SA', segment: 'B2B', status: 'ACTIVE', mrr: 15400, healthScore: 92, lastInteraction: 'Hoje, 10:45', tags: ['VIP', 'FTTH Dedicado'] },
  { id: 'c-2', name: 'Carlos Ferreira', segment: 'B2C', status: 'ACTIVE', mrr: 150, healthScore: 45, lastInteraction: 'Hoje, 09:12', tags: ['Risco Churn'] },
  { id: 'c-3', name: 'Condomínio Alpha', segment: 'B2B', status: 'IN_ACTIVATION', mrr: 4500, healthScore: 100, lastInteraction: 'Ontem, 16:30', tags: ['Projeto Fibra'] },
  { id: 'c-4', name: 'Mariana Silva', segment: 'B2C', status: 'SUSPENDED', mrr: 220, healthScore: 10, lastInteraction: 'Há 3 dias', tags: ['Inadimplente'] },
  { id: 'c-5', name: 'Logística Sul Ltda', segment: 'B2B', status: 'ACTIVE', mrr: 8900, healthScore: 88, lastInteraction: 'Há 1 semana', tags: ['PABX Nuvem'] },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <KpiCard title="Total de Clientes" value="4.852" subtitle="Ativos na base" icon={<Users className="text-blue-600" />} />
        <KpiCard title="MRR (Receita Mensal)" value="R$ 412.5k" subtitle="+12% em relação ao mês anterior" icon={<Activity className="text-emerald-600" />} />
        <KpiCard title="Clientes VIP (B2B)" value="124" subtitle="Representam 45% do MRR" icon={<Building2 className="text-indigo-600" />} />
        <KpiCard title="Risco de Churn" value="38" subtitle="Health Score < 40" icon={<Activity className="text-amber-600" />} alert />
      </div>
